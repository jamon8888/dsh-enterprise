...
from ict import sensitivity as sens_mod
...
def test_random_walk_discriminant_h1_or_h2():
    ...
    test_random_walk_discriminant_h1_or_h2.verdict_saturation_persists_rw = (
        verdict_saturation_persists_rw  # type: ignore[attr-defined]
    )
