...
# --------------------------------------------------------------- estimation
def tpm_from_transitions(
    transitions, mapping: dict | None = None, unseen: str = "self"
):
...
def tpm_from_trajectory(states, mapping: dict | None = None, unseen: str = "self"):
...
def tpm_from_trajectories(
    trajectories, mapping: dict | None = None, unseen: str = "self"
):
