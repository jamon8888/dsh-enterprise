...
def test_full_inhibition_blocks_invention():
    ...
    g = InhibitedInventingGame(
        4, 1, max_signals=4, inhibition_growth=0.0, rng=np.random.default_rng(0)
    )
...
def test_inhibition_decay_on_success():
    ...
    g0 = InhibitedInventingGame(
        4,
        1,
        temperature=0.6,
        invention_rate=0.1,
        inhibition_growth=0.1,
    ...
    g1 = InhibitedInventingGame(
        4,
        1,
        temperature=0.6,
        invention_rate=0.1,
        inhibition_growth=0.1,
        inhibition_decay=0.3,
        rng=np.random.default_rng(0),
    )
...
def test_play_round_returns_coherent_tuple():
    ...
    g = InhibitedInventingGame(
        3, 2, temperature=0.5, inhibition_growth=0.1, rng=np.random.default_rng(0)
    )
...
def test_inhibition_history_length_matches_rounds():
    ...
    g = InhibitedInventingGame(
        3, 1, temperature=0.5, inhibition_growth=0.1, rng=np.random.default_rng(0)
    )
