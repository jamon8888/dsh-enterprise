...
def test_nom_historique_conserve_a_l_octet():
    ...
    assert (
        trace_filename(
            "trained", 16, model=MODEL_9B, default_model=MODEL_9B, n_layers=N_LAYERS_9B
        )
        == "ict21_sae_layer16_trained.npz"
    )
    assert (
        trace_filename(
            "control", 16, model=MODEL_9B, default_model=MODEL_9B, n_layers=N_LAYERS_9B
        )
        == "ict21_sae_layer16_control.npz"
    )
...
def test_deux_echelles_a_la_meme_couche_ne_collisionnent_pas():
    ...
    """
    name_9b = trace_filename(
        "trained", 16, model=MODEL_9B, default_model=MODEL_9B, n_layers=N_LAYERS_9B
    )
    name_2b = trace_filename(
        "trained", 16, model=MODEL_2B, default_model=MODEL_9B, n_layers=N_LAYERS_2B
    )
...
def test_sae_2b_l100_a_meme_d_sae_que_l50_mais_k_different():
    ...
    from scripts.extract_sae_traces import fetch_sae_config
...
def test_trace_filename_discrimine_l50_et_l100_par_le_slug_du_repo():
    ...
    name_l50 = trace_filename(
        "trained", 12, model=MODEL_2B, default_model=MODEL_9B, n_layers=N_LAYERS_2B
    )
    name_l100 = trace_filename(
        "trained", 12, model=MODEL_2B, default_model=MODEL_9B, n_layers=N_LAYERS_2B
    )
